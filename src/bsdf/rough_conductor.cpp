#include "bsdf/rough_conductor.hpp"
#include "bsdf/bsdf_core.hpp"

RoughConductor::RoughConductor(const vec3& ref,
                               FLOAT ani_x,
                               FLOAT ani_y,
...
void RoughConductor::Sample(vec3& wgt,Ray& ray_o,const Ray& ray_i,const Hitpoint& hp,Random& random) const{
    //hit back side
    ...
    //outgoing ray
    //transform omega_i to global coordinate
