...
Triangle::Triangle(const vec3& xyz1,
                   const vec3& xyz2,
                   const vec3& xyz3,
                   const vec2& uv1,
                   const vec2& uv2,
...
void Triangle::CreateAABB(AABB& aabb) const{
    FLOAT range_x[2],range_y[2],range_z[2];
    range_x[0] = std::min(m_xyz1[0],std::min(m_xyz2[0],m_xyz3[0]));
    range_x[1] = std::max(m_xyz1[0],std::max(m_xyz2[0],m_xyz3[0]));
    range_y[0] = std::min(m_xyz1[1],std::min(m_xyz2[1],m_xyz3[1]));
    range_y[1] = std::max(m_xyz1[1],std::max(m_xyz2[1],m_xyz3[1]));
    range_z[0] = std::min(m_xyz1[2],std::min(m_xyz2[2],m_xyz3[2]));
    range_z[1] = std::max(m_xyz1[2],std::max(m_xyz2[2],m_xyz3[2]));
